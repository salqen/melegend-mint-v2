        ...
        <Container flex={1} ai={"center"} style={{ padding: 24, backgroundColor: "var(--primary)" }} image={bg.src}>
          ...
          <ResponsiveWrapper style={{ padding: 24 }}>
            ...
            >
              ...
              >
                <TextTitle>MELEGEND PRESALE IS LIVE!</TextTitle>
                {contract.totalSupply} / {contract.maxSupply - 888}
              </TextTitle>
              <TextDescription
                style={{
                  textAlign: "center",
              ...
              {contract.totalSupply >= contract.maxSupply - 888 ? (
                <>
                  ...
                  <TextDescription style={{ textAlign: "center", color: "var(--accent-text)" }}>
                ...
                <>
                  <TextTitle style={{ textAlign: "center", color: "var(--accent-text)" }}>
                    1 {CONFIG.SYMBOL} costs {CONFIG.DISPLAY_COST} {CONFIG.NETWORK.SYMBOL}. <br></br>(Excluding gas fees)
                  </TextTitle>
                  {!wallet.connected ? (
                    ...
                    <>
                      ...
                      <Container ai={"center"} jc={"center"} fd={"row"}>
                        <StyledButton
                          onClick={() => {
                            presaleMint(wallet?.accounts?.[0] as string, 1);
                          }}
                        >
                          MINT
                        </StyledButton>
