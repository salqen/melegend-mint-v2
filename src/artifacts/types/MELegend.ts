...
export interface MELegendInterface extends utils.Interface {
  contractName: "MELegend";
  functions: {
...
export interface MELegend extends BaseContract {
  contractName: "MELegend";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MELegendInterface;
