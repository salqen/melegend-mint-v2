...
export interface MeLegendGen1Interface extends utils.Interface {
  contractName: "MeLegendGen1";
  functions: {
    "_genesisClaimed(uint256)": FunctionFragment;
    ...
    "enableClaiming()": FunctionFragment;
    "enablePresale(bytes32)": FunctionFragment;
    "enablePublic()": FunctionFragment;
    "genesisNFT()": FunctionFragment;
    "getApproved(uint256)": FunctionFragment;
    "isApprovedForAll(address,address)": FunctionFragment;
    "maxClaimSupply()": FunctionFragment;
    ...
    "presaleMintLimit()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "_genesisClaimed",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "maxClaimSupply",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "presaleMintLimit",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface MeLegendGen1 extends BaseContract {
  contractName: "MeLegendGen1";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MeLegendGen1Interface;
  ...
  functions: {
    ...
    genesisNFT(overrides?: CallOverrides): Promise<[string]>;
    ...
    maxClaimSupply(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    presaleMintLimit(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  callStatic: {
    ...
    enableClaiming(overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    genesisNFT(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    genesisNFT(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    maxClaimSupply(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    presaleMintLimit(overrides?: CallOverrides): Promise<PopulatedTransaction>;
